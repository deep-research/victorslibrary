    ...
    <div class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
      <div class="flex flex-col max-w-screen-xl px-6 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        ...
        <nav :class="{'flex': mobile_open, 'hidden': !mobile_open}" class="mx-4 flex-col flex-grow mb-5 md:pb-0 md:flex md:justify-center md:flex-row md:space-x-4 > *">
          ...
          <!-- CURRENT LINKS -->
          <g-link :class="{'text-gray-900 bg-gray-200': currentPage('/')}" class="no-underline rounded-sm hover:bg-gray-300 hover:no-underline px-4 py-2 mt-3 text-sm font-semibold bg-transparent md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" to="/">Home</g-link>
          <g-link :class="{'text-gray-900 bg-gray-200': currentPage('/music/')}" class="no-underline rounded-sm hover:bg-gray-300 hover:no-underline px-4 py-2 mt-2 text-sm font-semibold bg-transparent md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" to="/music/">Music</g-link>   
