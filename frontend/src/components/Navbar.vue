    ...
    <div class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
      <div class="flex flex-col max-w-screen-xl px-6 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        <div :class="{'pb-5': !mobile_open}" class="px-3 flex flex-row items-center justify-between md:hidden">
          <a v-on:click="mobile_open = !mobile_open" href="#" class="px-1 text-lg font-semibold tracking-widest text-gray-900 uppercase dark-mode:text-white md:hidden">Menu</a> <!-- focus:outline-none focus:shadow-outline --> <!-- v-on:click="$event.target.blur()" -->
          <button class="md:hidden" v-on:click="mobile_open = !mobile_open"> <!-- focus:outline-none focus:shadow-outline -->
