    ...
    <div class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
      <div class="flex flex-col max-w-screen-xl px-6 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        <div :class="{'pb-5': !mobile_open}" class="px-3 flex flex-row items-center justify-between md:hidden">
          <a v-on:click="mobile_open = !mobile_open" href="#" class="px-1 text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-white md:hidden">Menu</a> <!-- focus:outline-none focus:shadow-outline --> <!-- v-on:click="$event.target.blur()" -->
          <button class="md:hidden rounded-lg" v-on:click="mobile_open = !mobile_open"> <!-- focus:outline-none focus:shadow-outline -->
        ...
        <nav :class="{'flex': mobile_open, 'hidden': !mobile_open}" class="flex-col flex-grow pb-5 md:pb-0 md:flex md:justify-center md:flex-row md:space-x-4 > *">
          ...
          <!-- CURRENT LINKS -->
          <g-link :class="{'text-gray-900 bg-gray-200': currentPage('/')}" class="hover:no-underline px-4 py-2 mt-3 text-sm font-semibold bg-transparent md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200" to="/">Home</g-link>
          <g-link :class="{'text-gray-900 bg-gray-200': currentPage('/music/')}" class="hover:no-underline px-4 py-2 mt-2 text-sm font-semibold bg-transparent md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200" to="/music/">Music</g-link>   
